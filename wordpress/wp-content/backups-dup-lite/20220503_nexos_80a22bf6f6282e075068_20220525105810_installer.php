...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220503_nexos_80a22bf6f6282e075068_20220525105810_archive.zip';
	const ARCHIVE_SIZE		 = '37444058';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '80a22bf-25105810';
    const SECONDARY_PACKAGE_HASH = 'd6f1866-25105810';
	const VERSION			 = '1.4.5';
