...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220503_nexos_a28a6bad60a4faa68567_20220726001249_archive.zip';
	const ARCHIVE_SIZE		 = '72891635';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'a28a6ba-26001249';
    const SECONDARY_PACKAGE_HASH = 'cbae1b3-26001249';
	const VERSION			 = '1.4.7';
